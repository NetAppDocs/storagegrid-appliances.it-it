...
---
= Sostituire lo storage controller della serie E2800 nell'SG5700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
CAUTION: *Possibile danno all'hardware* -- La flangia metallica nella parte anteriore della batteria deve essere completamente inserita nello slot sul controller (come mostrato nella prima figura). Se la batteria non è installata correttamente (come mostrato nella seconda figura), la flangia metallica potrebbe entrare in contatto con la scheda del controller, causando danni.
...
** *Errato - La flangia metallica della batteria non è inserita nell'apposito slot sul controller:*
+
