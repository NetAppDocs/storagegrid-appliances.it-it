...
---
= Aggiungere uno shelf di espansione a un'appliance SG6060 già implementata
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Sono disponibili il ripiano di espansione e quattro cavi SAS per ogni ripiano di espansione.
...
+
Esempi di messaggi che potrebbero apparire nella Home page, a seconda del numero di scaffali di espansione esistenti o nuovi:
