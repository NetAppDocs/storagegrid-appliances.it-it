...
summary: 'Per i controller di storage che attualmente utilizzano SANtricity OS 08.42.20.00 (11.42) o versione successiva, è necessario utilizzare Grid Manager per applicare un aggiornamento.' 
---
= Aggiorna il sistema operativo SANtricity sui controller di storage SG6000 con Grid Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
