...
+
Se sono state apportate modifiche alle impostazioni della VLAN, la subnet dell'appliance potrebbe essere cambiata. Se è necessario modificare gli indirizzi IP dell'appliance, seguire la procedura https://docs.netapp.com/us-en/storagegrid-118/maintain/configuring-ip-addresses.html["Configurare gli indirizzi IP"^] istruzioni.
