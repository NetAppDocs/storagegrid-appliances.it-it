...
---
= Utilizzare la scheda Gestisci unità per gli appliance StorageGRID SG110, SG120, SG1100, SG1200, SG6100 e SG6200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Dal Grid Manager, selezionare *Nodi* > *_data center_*.
