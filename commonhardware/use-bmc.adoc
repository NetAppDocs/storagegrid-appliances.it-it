...
---
= Controller di gestione della scheda madre per StorageGRID appliances
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* https://docs.netapp.com/us-en/storagegrid/harden/hardening-guidelines-for-storagegrid-nodes.html#change-appliance-bmc-password["Cambia la password BMC dell'appliance in Grid Manager"^]
* https://docs.netapp.com/us-en/storagegrid/maintain/changing-nodes-network-configuration.html#change-appliance-node-bmc-lan-ip-settings["Configura le impostazioni IP LAN di BMC"^]
...
+
** link:../installconfig/troubleshooting-hardware-installation-sg100-and-sg1000.html["SG100 e SG1000"]
** link:../installconfig/troubleshooting-hardware-installation-sg110-and-sg1100.html["SG110 e SG1100"]
** link:../installconfig/troubleshooting-hardware-installation-sg120-and-sg1200.html["SG120 e SG1200"]
...
** link:../sg110-1100/power-sg110-and-sg1100-off-on.html["SG110 e SG1100"]
** link:../sg120-1200/power-sg120-and-sg1200-off-on.html["SG120 e SG1200"]
...
** link:../sg120-1200/turning-sg120-and-sg1200-identify-led-on-and-off.html["SG120 e SG1200"]
