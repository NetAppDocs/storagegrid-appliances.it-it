...
La clonazione dei nodi non è supportata da un'appliance del nodo sorgente SGF6112 senza crittografia dei nodi a un'appliance di destinazione SGF6112 con crittografia dei nodi.
