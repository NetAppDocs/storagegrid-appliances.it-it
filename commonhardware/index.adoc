...
---
= Procedure di manutenzione comuni per le appliance StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* link:../sg6200/index.html["Manutenzione dell'appliance SG6200"]
...
* link:../sg120-1200/index.html["Manutenzione degli apparecchi SG120 e SG1200"]
