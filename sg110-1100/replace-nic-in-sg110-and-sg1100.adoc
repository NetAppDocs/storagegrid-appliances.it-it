...
summary: 'Potrebbe essere necessario sostituire la scheda di interfaccia di rete (NIC) di SG110 o SG1100 se non funziona correttamente o se presenta un guasto.' 
---
= Sostituire una scheda di rete in un SG110 o SG1100
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
