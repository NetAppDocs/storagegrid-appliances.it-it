...
summary: È possibile sostituire un alimentatore nel SG5812. 
---
= Sostituire l'alimentatore nell'SG5812
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
È possibile sostituire un alimentatore in un SG5812.

.A proposito di questa attività
Se si prevede di sostituire un alimentatore, tenere presenti i seguenti requisiti.

* È necessario disporre di un alimentatore di ricambio supportato per l'apparecchio.
...
+
** Un alimentatore di ricambio supportato per il modello di appliance del controller.
...
Preparare la sostituzione dell'alimentatore.
