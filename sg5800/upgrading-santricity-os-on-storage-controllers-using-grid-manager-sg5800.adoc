...
summary: È possibile utilizzare Grid Manager per applicare un aggiornamento. 
---
= Aggiorna il SANtricity OS sui controller di storage SG5800 utilizzando Grid Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
È possibile utilizzare Grid Manager per applicare un aggiornamento. È anche possibile link:upgrading-santricity-os-on-storage-controller.html["utilizzare la modalità di manutenzione per applicare un aggiornamento"].
