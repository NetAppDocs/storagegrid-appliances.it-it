...
---
= Aggiorna il sistema operativo SANtricity sugli storage controller SG5800 usando Grid Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per gli storage controller che attualmente utilizzano SANtricity OS 08.42.20.00 (11,42) o versione successiva, puoi utilizzare il Grid Manager per applicare un aggiornamento. Puoi anche farlo link:upgrading-santricity-os-on-storage-controller.html["utilizzare la modalità di manutenzione per applicare un aggiornamento"].
