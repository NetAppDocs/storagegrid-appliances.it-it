...
summary:  
---
= Sostituire la batteria nel controller E4000 in un SG5800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
** Da Grid Manager, selezionare *Nodi* > *nodo dell'appliance* > *SANtricity System Manager*. Le informazioni del controller si trovano su https://docs.netapp.com/us-en/storagegrid/monitor/viewing-santricity-system-manager-tab.html["Scheda Gestore di sistema di SANtricity"].
...
+
.. Nel Grid Manager, selezionare *Nodi*.
