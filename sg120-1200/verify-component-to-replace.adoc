...
---
= Verificare il componente da sostituire nell'SG120 o nell'SG1200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
link:turning-sg120-and-sg1200-identify-led-on-and-off.html["Accendere il LED di identificazione dell'apparecchio"]
