...
1
 a| 
NIC 1 nell'assemblaggio riser a singolo slot
 a| 
Porte di rete Ethernet 10/25-GbE per Grid e Client Networks
...
2
 a| 
NIC 2 nell'assemblaggio riser a singolo slot
 a| 
Porte di rete Ethernet 1/10-GbE per Admin Network
...
3
 a| 
NIC 3 nell'assemblaggio riser a singolo slot
 a| 
Porte di rete Ethernet 10/25-GbE per Grid e Client Networks
...
NOTE: L'appliance SG1200 supporta porte di rete ad alta velocità e potrebbe avere NIC ad alta velocità installate.
