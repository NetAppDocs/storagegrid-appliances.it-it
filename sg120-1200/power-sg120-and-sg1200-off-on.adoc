...
---
= Spegnere e accendere SG120 o SG1200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
È possibile spegnere l'apparecchio SG120 o SG1200 e riaccenderlo per eseguire manutenzione.



== Spegnere l'appliance SG120 o SG1200
...
== Accendere SG120 o SG1200 e verificarne il funzionamento

Accendere il controller dopo aver completato la manutenzione.

.Prima di iniziare
* Hai link:reinstalling-sg120-and-sg1200-into-cabinet-or-rack.html["installato il controller in un armadietto o in un rack"] e collegato i cavi dati e di alimentazione.
* Hai link:locating-sg120-and-sg1200-in-data-center.html["posizione fisica del controller nel data center"].
