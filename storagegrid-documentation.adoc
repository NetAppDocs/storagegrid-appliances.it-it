...
[role="lead"]
Vai su  https://docs.netapp.com/us-en/storagegrid/index.html["Documentazione di StorageGRID 12.1"^] per scoprire come configurare e usare un sistema StorageGRID 12.1.
...
* https://docs.netapp.com/us-en/storagegrid-120/index.html["Documentazione StorageGRID 12.0"^]
* https://docs.netapp.com/us-en/storagegrid-119/index.html["Documentazione di StorageGRID 11,9"^]
