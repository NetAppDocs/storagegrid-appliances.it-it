...
[role="lead"]
Vai a https://docs.netapp.com/us-en/storagegrid/index.html["Documentazione StorageGRID 12.0"^] per imparare a configurare e utilizzare un sistema StorageGRID 12.0.
