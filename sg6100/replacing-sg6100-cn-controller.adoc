...
. Se la centralina SG6100-CN funziona sufficientemente da consentire uno spegnimento controllato, link:power-sg6100-cn-controller-off-on.html#shut-down-sg6100-cn-controller["Spegnere la centralina SG6100-CN"].
