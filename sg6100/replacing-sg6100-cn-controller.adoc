...
---
= Sostituire il controller SG6100-CN
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.. link:reinstalling-sgf6112-into-cabinet-or-rack.html["Rimuovere il controller guasto dall'armadio o dal rack"] .
.. Notare la posizione dei componenti sostituibili (due alimentatori, tre schede di rete e due SSD) nel controller guasto.
+
...
+
image::../media/sg6100cn_ssds_locations.png[Posizioni delle unità]
...
|===
.. Trasferire i componenti sostituibili al controller sostitutivo.
+
Seguire le istruzioni di manutenzione fornite per reinstallare i componenti sostituibili.

+

CAUTION: Se si desidera conservare i dati sulle unità, inserire le unità SSD negli stessi slot che occupavano nell'appliance guasta.  In caso contrario, l'Appliance Installer visualizzerà un avviso e sarà necessario inserire le unità negli slot corretti e riavviare il controller prima che questo possa riconnettersi alla rete.

.. link:reinstalling-sgf6112-into-cabinet-or-rack.html["Installare il controller sostitutivo nell'armadio o nel rack"] .
