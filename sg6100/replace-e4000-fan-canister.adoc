...
.. Guardare la ventola image:../media/sam1130_ss_hardware_fan_icon_maint-e2800.gif[""] A destra degli elenchi a discesa *ripiano* per determinare quale dispositivo presenta il filtro della ventola guasto.
+
