...
summary: È possibile utilizzare Grid Manager o la modalità di manutenzione per applicare un aggiornamento. 
---
= Aggiorna il sistema operativo SANtricity sugli storage controller SG6160 utilizzando Grid Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
