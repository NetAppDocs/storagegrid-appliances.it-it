...
summary: 'Potresti dover sostituire la scheda di interfaccia di rete (NIC) nell’SG6100-CN se non funziona in modo ottimale o se si è guastata.' 
---
= Sostituire una scheda di rete esterna in un SG6100-CN
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Per evitare interruzioni del servizio, verificare che tutti gli altri nodi di archiviazione siano connessi alla rete prima di iniziare la sostituzione della scheda di interfaccia di rete (NIC) oppure sostituire la NIC durante una finestra di manutenzione programmata quando i periodi di interruzione del servizio sono accettabili.  Vedi informazioni su https://docs.netapp.com/us-en/storagegrid/monitor/monitoring-system-health.html#monitor-node-connection-states["stati di connessione del nodo di monitoraggio"^] .
