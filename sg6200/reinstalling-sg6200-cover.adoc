...
---
= Sostituire il coperchio SGF6212 o SG6200-CN
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. link:reinstalling-sg6200-into-cabinet-or-rack.html["Rimuovete l'apparecchio dal cabinet o dal rack"] per accedere al coperchio superiore.
...
. link:reinstalling-sg6200-into-cabinet-or-rack.html["Reinserite l'apparecchio nell'armadietto o nel rack"].
