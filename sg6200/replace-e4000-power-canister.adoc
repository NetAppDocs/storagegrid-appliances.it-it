...
---
= Sostituire il contenitore di alimentazione nello storage controller shelf o shelf di espansione (SG6260)
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
È possibile sostituire un alimentatore in uno shelf storage controller SG6260 o in uno shelf di espansione (DE460C).
