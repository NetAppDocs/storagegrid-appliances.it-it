...
---
= Sostituire il contenitore della ventola nello shelf dello storage controller o nello shelf di espansione (SG6260)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
È possibile sostituire il contenitore della ventola in un SG6260.
