...
summary: 'Potresti dover sostituire la scheda di interfaccia di rete (NIC) nell’SGF6212 se non funziona in modo ottimale o se si è guastata.' 
---
...
NOTE: Alcuni dispositivi supportano porte di rete ad alta velocità e potrebbero avere NIC ad alta velocità installate.
