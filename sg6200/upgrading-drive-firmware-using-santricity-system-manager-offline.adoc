...
---
= Aggiorna il firmware del disco SG6200 utilizzando SANtricity System Manager con il metodo offline (SG6260)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Questa procedura *non* si applica alle unità SSD NVMe presenti nell'SG6200-CN, che vengono aggiornate durante gli aggiornamenti del software StorageGRID. Solo le unità presenti nell'E4000 possono essere aggiornate utilizzando questa procedura.
...
** Utilizzare Grid Manager e selezionare *Nodi* > *_Storage Node_* > *SANtricity System Manager*
