...
---
= Sostituire il disco nello shelf dello storage controller o nello shelf di espansione (SG6260)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
È possibile sostituire un disco in uno shelf storage controller SG6260 o in uno shelf di espansione (DE460C).
