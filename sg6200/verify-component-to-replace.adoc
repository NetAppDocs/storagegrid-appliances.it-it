...
---
= Verificare il componente da sostituire nel modello SGF6212 o SG6200-CN
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
link:turning-sg6200-identify-led-on-and-off.html["Accendere il LED di identificazione dell'apparecchio"]
