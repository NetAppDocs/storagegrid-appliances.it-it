...
---
= Sostituire l'appliance SGF6212
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.. link:reinstalling-sg6200-into-cabinet-or-rack.html["Rimuovere l'apparecchio guasto dall'armadietto o dal rack"].
...
+
image::../media/sgf6212_front_with_ssds.png[Posizioni delle ventole]
...
CAUTION: Se si desidera conservare i dati presenti sulle unità, assicurarsi di inserire le unità SSD negli stessi slot che occupavano nell'appliance guasta. In caso contrario, Appliance Installer visualizzerà un messaggio di avviso e sarà necessario inserire le unità negli slot corretti e riavviare l'appliance prima che l'appliance possa rientrare nel grid.

.. link:reinstalling-sg6200-into-cabinet-or-rack.html["Installare l'apparecchio sostitutivo nell'armadietto o nel rack"].
...
* link:../installconfig/troubleshooting-hardware-installation-sg6200.html#view-boot-codes["Visualizzare i codici di avvio dell'appliance"]
