...
summary: 'È possibile spegnere l"apparecchio SG6200 e riaccenderlo per eseguire manutenzione.' 
---
= Spegnere e riaccendere l'apparecchio SGF6212 o il controller SG6200-CN
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
È possibile spegnere l'apparecchio SGF6212 o il controller SG6200-CN e riaccenderli per eseguire manutenzione.



== Spegnere l'appliance SGF6212 o il controller SG6200-CN
...
== Accendere SGF6212 o SG6200-CN e verificarne il funzionamento

Accendere il controller dopo aver completato la manutenzione.

.Prima di iniziare
* Hai link:reinstalling-sg6200-into-cabinet-or-rack.html["installato il controller in un armadietto o in un rack"] e collegato i cavi dati e di alimentazione.
* Hai link:locating-sg6200-in-data-center.html["posizione fisica del controller nel data center"].
