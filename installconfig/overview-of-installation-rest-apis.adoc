...
summary: 'StorageGRID fornisce due API REST per l"esecuzione delle attività di installazione, la StorageGRID Installation API e la StorageGRID Appliance Installer API.' 
---
= StorageGRID API REST per l'installazione di StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
