...
---
= Raccogli le informazioni di rete per l'SG6200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Prima di installare un appliance SGF6212 o SG6260, verificare che il sistema StorageGRID utilizzi una versione richiesta del software StorageGRID.
...
Entrambi i controller di storage dell'appliance SG6260 vanno collegati alla rete di gestione che verrà utilizzata per SANtricity System Manager. Il controller A si trova in alto e il controller B in basso.
...
Porte RJ-45 sul dispositivo SGF6212:

image::../media/sgf6212_rj_45_ports.png[Porte RJ-45 SGF6212]

Porte RJ-45 sul controller SG6200-CN:

image::../media/sg6200_cn_rj_45_ports.png[Porte RJ-45 SG6200-CN]
...
Le seguenti figure mostrano la porta di gestione BMC sui modelli SGF6212 e SG6200-CN.

_SGF6212_

image::../media/sgf6212_bmc_management_port.png[Porta di gestione SGF6212]

_SG6200-CN_

image::../media/sg6200_cn_bmc_management_port.png[Porta di gestione SG6200-CN]
...
Quando link:configuring-network-links.html["configurazione dei collegamenti di rete"] per l'appliance SGF6212, è possibile utilizzare il port bonding per le porte che si connettono alla Grid Network e alla Client Network opzionale, nonché per le porte di gestione 1/10-GbE che si connettono alla Admin Network opzionale. Il port bonding contribuisce a proteggere i dati fornendo percorsi ridondanti tra le reti StorageGRID e l'appliance.
...
image::../media/sg6200_cn_aggregate_ports.png[Modalità di bond della porta aggregata SG6200-CN]
...
image::../media/sgf6212_bonded_management_ports.png[Porte di gestione di rete SGF6212]

_SG6200-CN:_

image::../media/sg6200_cn_bonded_management_ports.png[Porte di gestione di rete SG6200-CN]
