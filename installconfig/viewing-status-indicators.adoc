...
* <<status_indicators_SG5800_controller,Indicatori di stato sul controller SG5800>>
* <<general_boot_codes_sg5800,Codici generali di boot>>
* <<boot_codes_SG5800_controller,SG5800 codici di avvio della centralina>>
* <<error_codes_SG5800_controller,SG5800 codici di errore della centralina>>


Utilizzare queste informazioni per ottenere assistenza link:troubleshooting-hardware-installation.html["Risolvere i problemi di installazione dell'hardware SG5800"].
...
+
--
La figura seguente mostra gli indicatori e i pulsanti sui dispositivi SG6100.
