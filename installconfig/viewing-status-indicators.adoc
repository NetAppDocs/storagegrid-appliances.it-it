...
---
= Visualizza gli indicatori di stato e i codici sui dispositivi StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* <<appliance_indicators_sg120_sg1200,Indicatori e pulsanti dell'apparecchio>>
* <<general_boot_codes_sg120_sg1200,Codici generali di boot>>
* <<ssd_indicators_sg120_sg1200,Indicatori SSD>>


Utilizza queste informazioni per aiutare link:troubleshooting-hardware-installation-sg120-and-sg1200.html["Risoluzione dei problemi di installazione hardware di SG120 e SG1200"].

[[appliance_indicators_sg120_sg1200]]
Indicatori e pulsanti dell'apparecchio::
+
--
La figura seguente mostra gli indicatori e i pulsanti presenti sulla parte frontale degli apparecchi SG120 e SG1200.

image::../media/sg120_sg1200_front_indicators.png[Indicatori frontali - SG120 e SG1200]
...
PFR
 a| 
Questa spia non viene utilizzata dagli apparecchi SG120 e SG1200 e rimane spenta.

|===
--


La figura seguente mostra la posizione dell'alimentatore e identifica i LED sul retro dei modelli SG120 e SG1200. Ulteriori LED di stato e di attività sono presenti sulle porte dell'appliance. Questi LED possono variare a seconda del modello dell'appliance.
...
+
--
La figura seguente mostra gli indicatori SSD sugli appliance SG120 e SG1200.
...
* <<appliance_indicators_SG6200,Indicatori e pulsanti dell'apparecchio>>
* <<general_boot_codes_SG6200,Codici generali di boot>>
* <<ssd_indicators_SG6200,Indicatori SSD>>


Utilizza queste informazioni per aiutare link:troubleshooting-hardware-installation-sg6200.html["Risoluzione dei problemi di installazione hardware SG6200"].

[[appliance_indicators_SG6200]]
Indicatori e pulsanti dell'apparecchio::
+
--
La figura seguente mostra gli indicatori e i pulsanti presenti sulla parte frontale degli apparecchi SG6200.

image::../media/s25_front_indicators.png[Indicatori frontali - SG6200]
...
PFR
 a| 
Questa spia non viene utilizzata dagli apparecchi SG6200 e rimane spenta.

|===
--


La figura seguente mostra la posizione dell'alimentatore e dei LED di identificazione sul retro dei modelli SGF6212 e SG6200-CN. Ulteriori LED di stato e di attività sono presenti sulle porte dell'appliance. Questi LED possono variare a seconda del modello dell'appliance.

image::../media/s25_rear_leds.png[LED posteriori SGF6212 e SG6200-CN]
...
+
--
La figura seguente mostra gli indicatori SSD sull'appliance SGF6212 o SG6260.
...
*Nota:* Se si inserisce un nuovo SSD funzionante in un nodo StorageGRID SGF6212 o SG6260 funzionante, i LED sull'SSD dovrebbero iniziare a lampeggiare, ma smetteranno di lampeggiare non appena il sistema determina che l'unità ha una capacità sufficiente ed è funzionante.
