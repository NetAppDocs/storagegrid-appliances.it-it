...
* link:gathering-installation-information-sg120-and-sg1200.html["SG120 e SG1200"]
...
* *Rete di gestione per SANtricity* (opzionale per gli appliance di storage, non necessaria per SGF6112 e SGF6212): questa rete fornisce l'accesso a SANtricity System Manager, consentendo di monitorare e gestire i componenti hardware nell'appliance e nello shelf dello storage controller. Questa rete di gestione può coincidere con la rete di amministrazione per StorageGRID oppure può essere una rete di gestione indipendente.
* *BMC management network* (opzionale per SG6000, SG6100, SG6200 e appliance di servizi): Questa rete fornisce l'accesso al baseboard management controller nelle SG6000, SG6100, SG6200 e appliance di servizi, consentendo di monitorare e gestire i componenti hardware dell'appliance. Questa rete di gestione può coincidere con la Admin Network di StorageGRID oppure può essere una rete di gestione indipendente.
+
