...
---
= Guida rapida per l'installazione dell'appliance StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
** link:installing-appliance-in-cabinet-or-rack-sg120-and-sg1200.html["SG120 e SG1200"]
...
. link:accessing-and-configuring-santricity-system-manager.html["Accedere e configurare Gestore di sistema di SANtricity"] (SG6260, SG6160, SG5700, SG5800 e SG6000)
. link:configuring-bmc-interface.html["Configurare l'interfaccia BMC"] (SG6200, SG6100, SG6000 e apparecchi di servizio)
...
** link:optional-changing-raid-mode.html["Modifica modalità RAID"] (SG6260, SG6160, SG6000, SG5860 e SG5760)
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png["Cinque"] Configurazione
[role="quick-margin-para"]
Quando tutti i nodi sono stati distribuiti, utilizzare Grid Manager per link:https://docs.netapp.com/us-en/storagegrid/swnodes/navigating-to-grid-manager.html["configura la griglia e completa l'installazione"^].
