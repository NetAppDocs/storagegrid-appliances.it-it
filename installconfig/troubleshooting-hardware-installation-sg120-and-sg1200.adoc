...
---
= Risoluzione dei problemi di installazione hardware per SG120 e SG1200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Fasi
. Prova a eseguire un ping sull'appliance utilizzando l'indirizzo IP dell'appliance:
+
`*ping _appliance_IP_*`
