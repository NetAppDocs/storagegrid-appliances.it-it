...
---
= Modificare la modalità RAID per un SG5760, SG5860, SG6000, SG6160 o SG6260
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
È possibile modificare la modalità RAID sui seguenti dispositivi:
...
** DDP offre protezione contro la perdita del cassetto negli appliance SG5760, SG5860, SG6160 e SG6260.
+
