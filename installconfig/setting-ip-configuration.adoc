...
---
= Configurare gli indirizzi IP dell'appliance StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* link:../sg120-1200/changing-link-configuration-of-sg120-and-sg1200-appliance.html["Modificare la configurazione del collegamento dell'appliance di servizi SG120 o SG1200"]
...
* link:../sg6200/changing-link-configuration-of-sg6200-appliance.html["Modificare la configurazione del collegamento dell'appliance SG6200"]
