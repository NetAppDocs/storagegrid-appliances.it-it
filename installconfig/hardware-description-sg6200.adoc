...
+
--
* Un processore AMD da 3,55 GHz che offre 32 core (64 thread)
* 256 GB DI RAM
* Unità di avvio interna da 256 GB (include StorageGRID software)
...
4
 a| 
Controller di archiviazione E-Series E4000 (1 di 2) e connettori
