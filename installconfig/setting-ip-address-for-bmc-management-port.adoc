...
---
= Impostare l'indirizzo IP della porta di gestione BMC su un'appliance StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Nelle impostazioni IP LAN, prendi nota dell'indirizzo IPv4 che viene visualizzato automaticamente.
+
