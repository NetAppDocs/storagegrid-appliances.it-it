...
---
= Installare gli shelf da 60 unità per un SG6260
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
CAUTION: Quando si installa il ripiano del controller E4000 o i ripiani di espansione opzionali, montare l'hardware dal basso verso l'alto del rack o dell'armadio per evitare che l'apparecchiatura si ribalti. Per garantire che l'apparecchiatura più pesante si trovi nella parte inferiore dell'armadio o del rack, installare il controller SG6200-CN sopra il ripiano del controller E4000 e i ripiani di espansione.
...
. Procedere con le istruzioni per l'installazione dell'SG6200-CN in un armadio o rack.
