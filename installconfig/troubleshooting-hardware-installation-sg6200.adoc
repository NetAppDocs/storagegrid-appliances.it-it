...
---
= Risoluzione dei problemi di installazione hardware per un SG6200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
== [[view-boot-codes]]Visualizza i codici di avvio (SGF6212 e SG6260 solo)
...
.. Verificare che i quattro cavi di interconnessione tra il controller SG6200-CN e i due storage controller siano collegati saldamente.
...
== [[view-error-codes]]Visualizza i codici di errore (solo SGF6212 e SG6260)
...
=== I shelf di espansione non vengono visualizzati in Appliance Installer (SG6260)
...
. Verifica di aver acceso i ripiani di espansione. Vedi link:connecting-power-cords-and-applying-power.html["Collegare i cavi di alimentazione e applicare l'alimentazione (SG6200)"].
. Se hai bisogno di aiuto per risolvere un problema, contatta il supporto tecnico.
