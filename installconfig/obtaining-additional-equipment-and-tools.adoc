...
---
= Procuratevi attrezzature e strumenti aggiuntivi per le appliance StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.SG120 e SG1200
--
Per installare e configurare l'hardware SG120 e SG1200, è necessaria la seguente attrezzatura aggiuntiva.
...
*** QSFP+ da 40 GbE
*** 100-GbE QSFP28
*** QSFP56 da 200-GbE (solo NIC da 200-GbE)
