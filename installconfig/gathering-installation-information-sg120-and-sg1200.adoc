...
---
= Raccogli informazioni di rete per SG120 e SG1200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Prima di installare un dispositivo di servizio SG120 o SG1200, verificare che il sistema StorageGRID utilizzi una versione richiesta del software StorageGRID.
...
SG120
 a| 
12.0 o versioni successive (si consiglia l'ultimo hotfix)
...
image::../media/sg120_rj_45_ports.png[Porte RJ-45 SG120]

Porte RJ-45 del modello SG1200:

image::../media/sg1200_rj_45_ports.png[Porte RJ-45 SG1200]
...
Velocità di collegamento
 a| 
Per il modello SG120, scegli una delle seguenti opzioni:
...
Per SG1200, scegli una delle seguenti opzioni:
...
* 40 GbE
* 100 GbE
* 200 GbE (solo 200GbE NIC)


*Nota:* Per SG1200, le velocità 10 e 25 GbE richiedono l'utilizzo di adattatori QSA.
...
Porta di gestione BMC SG120:

image::../media/sg120_bmc_management_port.png[Porta di gestione SG120]

Porta di gestione BMC SG1200:

image::../media/sg1200_bmc_management_port.png[Porta di gestione BMC SG1200]
...
Quando link:configuring-network-links.html["configurazione dei collegamenti di rete"] per gli appliance SG120 e SG1200, è possibile utilizzare il port bonding per le porte che si connettono alla Grid Network e alla Client Network opzionale, e per le porte di gestione 1-GbE1/10-GbE che si connettono alla Admin Network opzionale. Il port bonding contribuisce a proteggere i dati fornendo percorsi ridondanti tra le reti StorageGRID e l'appliance.
...
La modalità di aggregazione a porte fisse è la configurazione predefinita per le porte di rete. Le figure mostrano come le porte di rete su SG1200 o SG120 vengono aggregate in modalità di aggregazione a porte fisse.

SG120:

image::../media/sg120_fixed_port.png[Modalità di bond delle porte fisse SG120]

SG1200:

image::../media/sg1200_fixed_port.png[Modalità di collegamento a porta fissa SG1200]
...
image::../media/sg120_aggregate_ports.png[Modalità di bond della porta aggregata SG120]

SG1200:

image::../media/sg1200_aggregate_ports.png[Modalità di collegamento aggregato della porta SG1200]
...
image::../media/sg120_bonded_management_ports.png[Porte di gestione di rete aggregate SG120]

SG1200:

image::../media/sg1200_bonded_management_ports.png[Porte di gestione di rete aggregate SG1200]
