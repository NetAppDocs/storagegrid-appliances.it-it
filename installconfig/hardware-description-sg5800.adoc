...
summary: 'L"appliance SG5800 StorageGRID è una piattaforma integrata di storage ed elaborazione che funziona come Storage Node in una grid StorageGRID. L"appliance può essere utilizzata in un ambiente grid ibrido che combina Storage Node appliance e Storage Node virtuali (basati su software).' 
---
= Appliance StorageGRID SG5800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
