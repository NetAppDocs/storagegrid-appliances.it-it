...
summary: 'Devi accedere al programma di installazione di StorageGRID Appliance per verificare la versione dell"installer e configurare le connessioni tra l"appliance e le tre reti StorageGRID: la Grid Network, la Admin Network (opzionale) e la Client Network (opzionale).' 
---
...
.SG120
--
image::../media/sg120_admin_network_port.png[Porta di rete amministrativa sull'SG120]
...
.SG1200
--
image::../media/sg1200_admin_network_port.png[Porta di rete amministrativa su SG1200]
...
.SG6200-CN
--
image::../media/sg6200_cn_admin_network_port.png[Porta di rete amministrativa sul controller SG6200-CN]
...
.SGF6212
--
image::../media/sgf6212_admin_network_port.png[Porta di rete amministrativa sull'SGF6212]
...
image::../media/sg120_link_local_port.png[Connessione link-local SG120]
...
image::../media/sg1200_link_local_port.png[Connessione link-local SG1200]
...
.SG6200-CN
--
Collegare un laptop di servizio direttamente alla porta RJ-45 più a destra del controller SG6200-CN, utilizzando un cavo Ethernet.

image::../media/sg6200_cn_link_local_port.png[Posizione della porta di gestione per SG6200-CN]
...
image::../media/sgf6212_link_local_port.png[Connessione Link-Local SGF6212]
