...
---
= Configurare i collegamenti di rete per un'appliance StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* link:gathering-installation-information-sg120-and-sg1200.html#port-bond-modes["Modalità di collegamento delle porte (SG1200 e SG120)"]
...
* link:gathering-installation-information-sg6200.html#port-bond-modes["Modalità di collegamento delle porte (SGF6212 e SG6200-CN)"]
...
+
--
Le figure mostrano come le quattro porte di rete degli SG120 e SG1200 siano aggregate in modalità di aggregazione a porta fissa (configurazione predefinita).
...
image::../media/sg120_aggregate_ports.png[Modalità di collegamento della porta aggregata SG120]

SG1200:

image::../media/sg1200_aggregate_ports.png[Modalità di collegamento della porta aggregata SG1200]
...
image::../media/sg120_bonded_management_ports.png[Porte di rete amministrative aggregate SG120]

SG1200:

image::../media/sg1200_bonded_management_ports.png[Porte di rete amministrative aggregate SG1200]
...
image::../media/sgf6212_fixed_port.png[Modalità di bond delle porte fisse SGF6212]

*SG6200-CN*:

image::../media/sg6200_cn_fixed_port.png[SG6200-CN Modalità di collegamento a porta fissa]
...
image::../media/sgf6212_aggregate_ports.png[Modalità di collegamento aggregato della porta SGF6212]

*SG6200*:

image::../media/sg6200_cn_aggregate_ports.png[Modalità di collegamento aggregato della porta SG6200-CN]
...
image::../media/sgf6212_bonded_management_ports.png[Porte di rete amministrative aggregate SGF6212]

*SG6200*:

image::../media/sg6200_cn_bonded_management_ports.png[Porte di rete amministrative aggregate SG6200-CN]
...
+
Se si prevede di utilizzare la velocità di collegamento 25-GbE per le porte di rete SG6200, SG6100, SG6000, SG5800 o SG5700:
...
** Per i modelli SG5800, SG6000, SG6100 o SG6200, selezionare *Auto* dall'elenco a discesa *Velocità di collegamento*.
