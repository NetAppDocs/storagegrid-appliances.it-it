...
summary: 'Puoi accedere all"interfaccia BMC utilizzando l"indirizzo IP DHCP o statico per la porta di gestione BMC su alcuni modelli di appliance.' 
---
= Accedere all'interfaccia BMC su un'appliance StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.SG120
--
image::../media/sg120_bmc_management_port.png[Porta di gestione BMC SG120]
...
image::../media/sgf6212_bmc_management_port.png[Porta di gestione BMC SGF6212]

_SG6200-CN_:

image::../media/sg6200_cn_bmc_management_port.png[Porta di gestione BMC SG6200-CN]
